            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <iframe width="100%" class="rounded" height="250" src="https://www.youtube.com/embed/wxx9KaO5rJ4?si=SbRJxDHcZ0E0hp0N" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </div><br>
                <div class="card">
                    <div class="card-body">
                        <h3>Paket Wisata 2</h3>
                        <iframe width="100%" height="250" src="https://www.youtube.com/embed/_EoQ3hcmUKo?si=OXIpxa0VqvaEX_Ct" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </div><br>
                <div class="card">
                    <div class="card-body">
                        <h3>Paket Wisata 3</h3>
                        <iframe width="100%" height="250" src="https://www.youtube.com/embed/EEuz8PZ6RS0?si=eyNE5azVe3RVg02t" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
